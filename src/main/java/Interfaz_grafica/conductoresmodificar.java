 ...
 * @author eduardo
 */
public class conductoresmodificar extends javax.swing.JFrame {

    /**
     * Creates new form conductoresregistrar
     */
    public conductoresmodificar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(conductoresmodificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new conductoresmodificar().setVisible(true);
            }
        });
    }
    ...
    void modificar() {
        ...
        Cliente cliente = cli.buscarClientePorId(username);
        if (cliente != null) {
            String nuevapass = jTextField2.getText();
            String nuevoNombre = jTextField3.getText();
            String nuevaDireccion = jTextField4.getText();
            String nuevoTelefonoStr = jTextField5.getText();
            int nuevoTelefono = Integer.parseInt(nuevoTelefonoStr);
            String nuevoCorreo = jTextField6.getText();
            String nuevoUsuario = jTextField1.getText();
            String nuevaContrasena = jTextField2.getText();
            ...
            boolean exito = cli.modificar(cliente);
