 ...
 * @author eduardo
 */
public class vehiculosregistrar extends javax.swing.JFrame {

    /**
     * Creates new form conductoresregistrar
     */
    public vehiculosregistrar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vehiculosregistrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vehiculosregistrar().setVisible(true);
            }
        });
    }
    ...
    void registrar() {
        ...
        String especial = jTextField5.getText();
        ...
        if (especial.equalsIgnoreCase("Si")) {
            ...
            nuevoVehiculo = new Vehiculo(marca, modelo, año, matricula, "Ninguna");
        }

// Crear una instancia de vehiculoDAO
        VehiculoDAOFactory factory = (VehiculoDAOFactory) new VehiculoDAOFactoryImpl();
        VehiculoDAOInterface dao = factory.createVehiculoDAO();
